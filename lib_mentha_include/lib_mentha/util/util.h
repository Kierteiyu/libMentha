...
#include "lib_mentha/util/aligned_allocator.h"
#include "lib_mentha/util/macro.h"
#include "lib_mentha/util/nn_error.h"
#include "lib_mentha/util/parallel_for.h"
#include "lib_mentha/util/product.h"
#include "lib_mentha/util/random.h"
...
inline std::string to_string(vector_type vtype) {
  switch (vtype) {
    case lib_mentha::vector_type::data: return "data";
    case lib_mentha::vector_type::weight: return "weight";
    case lib_mentha::vector_type::bias: return "bias";
    case lib_mentha::vector_type::label: return "label";
    case lib_mentha::vector_type::aux: return "aux";
...
inline void printAvailableDevice(const size_t platform_id,
  ...
  nn_warn("libMentha was not build with OpenCL or CUDA support.");
#endif
}
