...
#include "lib_mentha/core/kernels/global_avepool_grad_op.h"
#include "lib_mentha/core/kernels/global_avepool_op.h"
...
#ifndef CNN_USE_AVX
      nn_warn(
        "libMentha has not been compiled with AVX support, "
